...
const CATALOG = {
  ...
  B0CS3V8M9H: {
    ...
    shortVerdict: "MaxCrisp technology blasts 450°F superheated air for maximum crunch on frozen fries and wings.",
    score: 9.3,
  ...
  B0C5JHKGFP: {
    ...
    shortVerdict: "Combines a cook probe with water atomizer misting for restaurant-quality steak and salmon on autopilot.",
    score: 9.4,
  ...
  B096N3FTZP: {
    ...
    shortVerdict: "ClearCook window and interior light let you monitor browning without opening the basket.",
    score: 9.1,
  ...
  B0BD4BYR11: {
    ...
    shortVerdict: "Refined 5.8-quart square basket fits a 5 lb whole chicken with 13 one-touch presets under $100.",
    score: 8.9,
  ...
  B0CDY277D3: {
    ...
    shortVerdict: "Two independent 3-quart baskets with windows and Sync Finish in a compact counter footprint.",
    score: 8.8,
